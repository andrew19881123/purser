...
// enterprise_sqlite.go — SQLiteRegistry implementations of the Wave B
// API Key Lifecycle methods (RotateAPIKey, UpdateAPIKeyLastUsed,
// ListAPIKeysExpiringBefore, RecordAPIKeyAccess, HasAnyAPIKey).
