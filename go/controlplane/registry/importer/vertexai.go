...
// vertexServiceAccountJSON is the subset of a Google service account JSON key
// file required for the JWT Bearer Grant (RFC 7523) used by VertexAI auth.
type vertexServiceAccountJSON struct {
...
func (c *VertexAIClient) tokenFromServiceAccount(ctx context.Context, credPath string) (string, error) {
	...
	var sa vertexServiceAccountJSON
