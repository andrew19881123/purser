...
| **Planner** | Go | `go/planner` | Dynamic-programming optimal layer-split algorithm. Prefix caching factor and KV-SSD offload are factored into placement estimates when reported by the engine. |
